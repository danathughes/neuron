...
GibVect3::GibVect3(const GibVect3* const vect)
{
...
GibVect3::GibVect3(const std::vector<float>* const vect)
{
	this->elements = std::vector<float>(3);
...
void GibVect3::x(const float newX) {
...
void GibVect3::y(const float newY) {
...
void GibVect3::z(const float newZ) {
